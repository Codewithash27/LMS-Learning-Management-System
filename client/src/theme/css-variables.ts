...
export const cssVariableMap: Record<string, string> = {
  ...
  "--primary": hexToHslChannels(colorTokens.preschool.turquoise.main),
  ...
  "--sidebar-background": hexToHslChannels(colorTokens.background.default),
  "--sidebar-foreground": "215 25% 27%",
  "--sidebar-primary": hexToHslChannels(colorTokens.preschool.turquoise.main),
  ...
  "--chart-1": hexToHslChannels(colorTokens.preschool.turquoise.main),
  "--chart-2": hexToHslChannels(colorTokens.preschool.coral.main),
  "--chart-3": hexToHslChannels(colorTokens.preschool.lavender.main),
  ...
  "--color-brand-blue": colorTokens.primary.main,
  "--color-turquoise": colorTokens.preschool.turquoise.main,
